...
<table border="1">
	...
	<tr>
		<td>
			<?php echo form_open('member/setting/edit_email');?>
...
<table border="1">
	...
	<tr>
		<td>
			<?php echo form_open('member/setting/edit_password');?>
...
<table border="1">
	...
	<tr>
		<td>
			<?php echo form_open('member/setting/edit_name');?>
...
<table border="1">
	...
	<tr>
		<td>
			<?php echo form_open('member/setting/edit_dob');?>
				<label>DOB</label>
				<select name="dob_day">
					<?php for ($i=1; $i <= 31; $i++) { ?>
...
<table border="1">
	...
	<tr>
		<td>
  			<?php echo form_open('member/setting/delete');?>
...
<a href="<?php echo site_url('member/welcome');?>">Back to home</a>
</body>
</html>